    ...
    const { data: rep, error: repErr } = await supabase
      ...
      .insert({
        ...
        history_summary: {
          ...
          on_time_ratio: Number(onTimeRatio.toFixed(2)),
          repay_on_time: repayOnTime,
          repay_late: repayLate,
          repay_overdue_open: repayOverdueOpen,
          missed_installments_total: totalMissedInstallments,
          penalty_amount_total: totalPenaltyAmount + totalRepaymentPenalty,
          overdraft_active: overdraftActive,
          overdraft_outstanding: overdraftOutstanding,
          overdraft_frozen: overdraftFrozen,
          overdraft_stale_days: overdraftStaleDays,
