...
BEGIN
  ...
  -- Only count successful or pending withdrawals (NOT failed ones)
  ...
  -- Only count successful/pending for daily limit, exclude failed
  ...
  -- Cooldown only applies to successful/pending (already filtered above)
  ...
  v_max_available := LEAST(v_self_deposit_balance, 150000 - v_today_instant_total);
