...
-- Create the missing user_profiles table to properly link auth users with employees
...
-- Remove all dangerous "Anyone can" policies that bypass authentication
...
-- Create trigger to automatically link employees to users when they're created
