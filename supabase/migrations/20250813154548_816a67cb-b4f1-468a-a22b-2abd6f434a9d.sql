...
-- Insert sample coffee records for training (using 'pending' status which should be valid)
...
('Arabica AA', 'Training Supplier A', CURRENT_DATE - INTERVAL '7 days', 1000, 17, 'pending', 'TRN-BATCH-001', (SELECT id FROM suppliers WHERE code = 'TRN-SUP-001')),
('Robusta Screen 18', 'Training Supplier B', CURRENT_DATE - INTERVAL '5 days', 600, 10, 'pending', 'TRN-BATCH-003', (SELECT id FROM suppliers WHERE code = 'TRN-SUP-002')),
