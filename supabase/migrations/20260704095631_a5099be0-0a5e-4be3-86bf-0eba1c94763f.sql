...
BEGIN
  ...
  VALUES (user_uuid::TEXT, 'LOYALTY_REWARD', actual_reward,
    ...
    json_build_object('activity_type', activity_name, 'reward', actual_reward, 'monthly_total', monthly_total + actual_reward, 'monthly_remaining', remaining_cap - actual_reward, 'cap', monthly_cap, 'multiplier', weight_multiplier),
    NOW());
