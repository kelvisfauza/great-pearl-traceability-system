DROP FUNCTION IF EXISTS public.identify_face_descriptor(jsonb);
...
BEGIN
  FOR r IN SELECT fc.user_id AS uid, fc.email AS em, fc.descriptor AS d FROM public.face_credentials fc LOOP
