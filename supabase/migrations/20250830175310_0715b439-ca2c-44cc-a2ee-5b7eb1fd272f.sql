-- Complete fix: Recreate all tables properly with TEXT user_id
...
-- Insert Denis's 30 daily salary entries with Firebase ID
...
-- Create Denis's user account with correct balance
