...
export const WithdrawalModal: React.FC<WithdrawalModalProps> = ({
        ...
        try {
          ...
          if (data && typeof data === 'object' && !Array.isArray(data)) {
            ...
            setInstantEligibility({
              ...
              daily_limit: Number(eligibilityData.daily_limit ?? 100000),
  ...
  const isUgandanMobileNumber = (value: string) => {
    ...
    return /^(070|074|075|076|077|078|079)\d{7}$/.test(normalizedValue) || /^(256(?:70|74|75|76|77|78|79))\d{7}$/.test(normalizedValue);
  };
...
<div class="voucher">
  <div class="header">
    ...
    <p style="font-size:11px;color:#666;margin:2px 0;">P.O Box 431420, Kasese, Uganda | +256 393 001 626 / +256 393 101 103</p>
