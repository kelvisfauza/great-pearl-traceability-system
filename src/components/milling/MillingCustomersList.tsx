...
import MillingCustomerEditDialog from './MillingCustomerEditDialog';
              ...
              <Table>
                ...
                <TableBody>
                  {filteredCustomers.map((customer) => (
                    <TableRow key={customer.id} className="cursor-pointer hover:bg-muted/50" onClick={() => setEditCustomer(customer)}>
                      <TableCell className="font-medium">{customer.full_name}</TableCell>
                      <TableCell>
                        {customer.phone || <span className="text-orange-500 text-xs">Missing</span>}
                      </TableCell>
