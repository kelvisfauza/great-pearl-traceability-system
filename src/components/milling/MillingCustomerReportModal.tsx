    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="space-y-6 p-4">
          {/* Print Header */}
          <div className="print:block hidden text-center border-b pb-4 mb-6">
            <h1 className="text-2xl font-bold">Customer Transaction Report</h1>
            <p className="text-lg">Milling Department</p>
          ...
          {/* Print Footer */}
          <div className="print:block hidden text-center text-sm text-muted-foreground border-t pt-4 mt-6">
            <p>This is a computer-generated report. No signature required.</p>
            <p>Generated by Milling Department Management System</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
