        ...
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-muted text-sm">
            ...
            <p className="text-muted-foreground italic">
              "Dear [Name], Quick Loans are now available! You qualify for up to UGX [3x salary]. Apply directly from your dashboard, get funds in your wallet instantly upon approval. Interest from 20%. Log in now. - Great Pearl Coffee"
            </p>
          </div>
