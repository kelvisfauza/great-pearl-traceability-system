          ...
          <div className="header" style={{ 
            ...
            <div className="logo-section" style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
              ...
              <div className="company-info">
                ...
                <p style={{ fontSize: '11px', opacity: 0.9, fontWeight: 'bold' }}>A Member of Hello YEDA Coffee Company Limited</p>
                <p style={{ fontSize: '11px', opacity: 0.9 }}>P.O Box 431420, Kasese, Uganda</p>
