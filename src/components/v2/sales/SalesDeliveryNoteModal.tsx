      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-white text-black p-6" id="sales-delivery-note">
          ...
          <div className="delivery-header text-center border-b-2 border-primary pb-5 mb-6">
            ...
            <h1 className="company-title text-2xl font-bold text-[#1a365d] uppercase tracking-wider mb-1">
              GREAT AGRO COFFEE
            </h1>
            <p className="company-tagline text-sm font-semibold text-[#1a5632] mb-1">A Member of Hello YEDA Coffee Company Limited</p>
          ...
          <div className="footer-note mt-8 p-4 bg-slate-100 rounded text-center text-xs text-gray-500">
            ...
            <p className="mt-1">Generated by Great Agro Coffee Management System</p>
          </div>
        </div>
