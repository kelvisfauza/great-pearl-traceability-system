      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Centralized permission management for all departments (HR, Admin, IT)
          </p>
        </CardHeader>
        <CardContent>
              ...
              {selectedUser ? (
                <>
                  <div className="p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Current: {selectedUser.department} • {selectedUser.position}
                    </p>
                  </div>
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-xs mt-2">
                    This unified system manages permissions for all departments
                  </p>
                </div>
              )}
            </div>
...
export default UnifiedPermissionManager;