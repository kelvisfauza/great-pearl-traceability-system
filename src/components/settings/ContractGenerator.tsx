  ...
  const generateContract = () => {
    ...
    const contractHTML = `
      ...
      <body>
        ...
        <div class="parties">
          <div class="party">
          <strong>EMPLOYER:</strong> Great Agro Coffee, a member of YEDA Coffee Company Limited, a company incorporated under the laws of Uganda with its registered office at P.O Box 431420, Kasese, Uganda (hereinafter referred to as "the Company").
          </div>
          <div class="party">
