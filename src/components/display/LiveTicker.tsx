...
const LiveTicker = () => {
  ...
  const fetchTickerData = async () => {
    ...
    if (tickerItems.length === 0) {
      tickerItems.push({ id: 'w', text: '☕ Welcome to Great Agro Coffee – Quality Coffee from the Rwenzori Mountains | Call: +256 393 001 626 | Operations: +256 393 101 103', type: 'info' });
    }
