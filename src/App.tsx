...
import GlobalHighlightBridge from "@/components/GlobalHighlightBridge";
...
import ScheduledMeetingPrompt from "@/components/calls/ScheduledMeetingPrompt";
...
import V2HRAttendance from "./pages/v2/hr/Attendance";
...
import { TraineeEnforcer } from "./components/trainee/TraineeEnforcer";
import { TraineeMasker } from "./components/trainee/TraineeMasker";
import { TraineeTour } from "./components/trainee/TraineeTour";
import { NonTraineeOnly } from "./components/trainee/NonTraineeOnly";
          ...
          <CallProvider>
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                <Route path="/v2/hr/attendance" element={<ProtectedRoute requiredPermissions={["Human Resources"]}><V2HRAttendance /></ProtectedRoute>} />
                ...
                <Route path="/excel-loyalty" element={
                  <ProtectedRoute requiredRoles={['Administrator', 'Super Admin', 'Managing Director']}>
                    <ExcelLoyalty />
                  </ProtectedRoute>
                } />
